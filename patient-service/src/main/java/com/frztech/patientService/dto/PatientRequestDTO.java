package com.frztech.patientService.dto;
...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Email is required") @Email(message = "Plase enter valid Email") String getEmail() {
        return email;
    }

    public void setEmail(@NotBlank(message = "Email is required") @Email(message = "Plase enter valid Email") String email) {
        this.email = email;
    }
